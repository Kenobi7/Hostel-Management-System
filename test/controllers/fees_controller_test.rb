...
class FeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee" do
    assert_difference("Fee.count") do
      post fees_url, params: { fee: { amount: @fee.amount, rollno: @fee.rollno, status: @fee.status } }
    end
  ...
  test "should update fee" do
    patch fee_url(@fee), params: { fee: { amount: @fee.amount, rollno: @fee.rollno, status: @fee.status } }
